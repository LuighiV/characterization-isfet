...
#        super(SerialAdapter,self).__init__() # is for the new style class
    ...
    def threadTempRead(self,start,liveplot,livevoltplot,livephplot,liveglassplot,recording):
        """
...
#                liveplot.appendData(self.temp,self.tempntc)
                ...
                if recording.writedata:
                    recording.recordTempData(self.temp,self.tempntc,self.voltph,self.phvalue,self.phglass)

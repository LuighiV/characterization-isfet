...
class MonitorMainContents(mmw.MeasureMainW):
    ...
    def initGUIContents(self):
        ...
        ##Group view
        #######################################
        self.livetempplot = lvcplt.LiveTwoPlotting()
        self.livevoltplot = lvcplt.LiveOnePlotting()
        self.livephplot = lvcplt.LiveOnePlotting()
        self.liveglassplot = lvcplt.LiveOnePlotting()
        self.measurements = ms.MonitorTwoView(self.livetempplot)
        self.measurevolts = ms.MonitorOneView(self.livevoltplot,'Volts')
        self.measureph = ms.MonitorOneView(self.livephplot,'pH')
        self.measureglass = ms.MonitorOneView(self.liveglassplot,'Glass')
        ...
        lview.addWidget(self.livevoltplot,1,0)
        lview.addWidget(self.measurevolts,1,1)
        lview.addWidget(self.livephplot,2,0)
        lview.addWidget(self.measureph,2,1)
        lview.addWidget(self.liveglassplot,3,0)
        lview.addWidget(self.measureglass,3,1)

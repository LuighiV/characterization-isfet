...
#        d.start()
        ...
        d2 = threading.Thread(name="threadtempread",
                                  ...
                                  args=(self.start,liveplot,livevoltplot,livephplot,liveglassplot,recording))
        d2.start()
        ...
        self.t.timeout.connect(liveglassplot.updateLiveData)
        ...
        self.t.timeout.connect(measureglass.updateData)

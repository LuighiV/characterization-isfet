...
class MonitorMainContents(mmw.MeasureMainW):
    ...
    def initGUIContents(self):
        ...
        self.measurements = ms.MonitorOneView(self.livetempplot,'NTC')
        #self.measurevolts = ms.MonitorOneView(self.livevoltplot,'Volts')
        self.measureph = ms.MonitorOneView(self.livephplot,'ISFET')
        ...
        lview.addWidget(self.liveglassplot,2,0)
        lview.addWidget(self.measureglass,2,1)
